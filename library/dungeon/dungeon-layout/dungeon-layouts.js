...
const DungeonLayouts = [
  ...
  new DungeonLayout('diamond', 'Diamond (♦)', [new MaskPolygon([[0.5, 0], [1, 0.5], [0.5, 1], [0, 0.5]])]),
  new DungeonLayout(
    'box', 'Box (◻)',
  ...
  new DungeonLayout('hexH', 'Hexagon (Horizontal ⬣)', [
    new MaskPolygon([[1, 0.5], [0.75, 0], [0.25, 0], [0, 0.5], [0.25, 1], [0.75, 1]]),
  ]),
  new DungeonLayout('hexV', 'Hexagon (Vertical ⬢)', [
    new MaskPolygon([[0.5, 1], [0, 0.75], [0, 0.25], [0.5, 0], [1, 0.25], [1, 0.75]]),
  ]),
  new DungeonLayout('pentagon', 'Pentagon (⬟)', [
    new MaskPolygon([[0.5, 0.0], [0.0, 0.4], [0.2, 1.0], [0.8, 1.0], [1.0, 0.4]]),
  ]),
  new DungeonLayout('star', 'Star (★)', [
    new MaskPolygon([[0.5, 0.0], [0.2, 1.0], [1.0, 0.4], [0.0, 0.4], [0.8, 1.0]]),
  ]),
  ...
  new DungeonLayout('L', 'Letter L', [
    new MaskPolygon([[0, 0], [1 / 3, 0], [1 / 3, 2 / 3], [1, 2 / 3], [1, 1], [0, 1]]),
  ]),
